/* ===========================================================================
   ...
   v1.62.0:
     ...
     • ارتفاع جدول خدمات «محاسبه» می‌شود تا تمام فضای آزاد صفحه را بگیرد،
       پس روی A4 حدود ۱۵ تا ۲۲ ردیف خدمت جا می‌شود (قبلاً ۸ تا ۱۰)
     • هشت پیش‌تنظیم ستونی (۳ تا ۷ ستون) با عنوان‌های تأییدشده در pdSvcColOf
   =========================================================================== */
(function () {
  "use strict";
  ...
  function svcModel(preset) {
    switch (preset) {
      case SVC4_ROW: return { cols: 4, header: true,
        widths: [0.07, 0.48, 0.30, 0.15],
        labels: ["ردیف", "نام خدمت", "شرح خدمت", "تعداد"] };
      case SVC4_CAT: return { cols: 4, header: true,
        widths: [0.40, 0.24, 0.11, 0.25],
        labels: ["نام خدمت", "نوع خدمت", "تعداد", "مبلغ کل"] };
      ...
      case SVC5_CODE: return { cols: 5, header: true,
        widths: [0.07, 0.15, 0.44, 0.10, 0.24],
        labels: ["ردیف", "کد خدمت", "نام خدمت", "تعداد", "مبلغ کل"] };
      case SVC6_FIN: return { cols: 6, header: true,
        widths: [0.06, 0.34, 0.09, 0.17, 0.14, 0.20],
        labels: ["ردیف", "نام خدمت", "تعداد", "مبلغ واحد", "تخفیف", "مبلغ کل"] };
      case SVC6_INS: return { cols: 6, header: true,
        widths: [0.06, 0.32, 0.09, 0.18, 0.17, 0.18],
        labels: ["ردیف", "نام خدمت", "تعداد", "مبلغ کل", "سهم بیمه", "سهم بیمار"] };
